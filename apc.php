...
if(!function_exists('apcu_cache_info')) {
	echo "No cache info available, APCu does not appear to be running. Please check the PHP settings in MAMP (PRO) for the selected cache module. If you are running PHP 7 please use apc.php for cache info.";
  exit;
}
...
<!-- //<script async src="https://api.countapi.xyz/hit/sky.bigbrain-studio.com/apc?callback=cbc"></script>

//  <script>
//    function cbc(response) {
//      document.querySelector("#visits").textContent = " HIT  =  " + response.value;
//    }
//  </script>
//<h11>This site has been visited <span id="visits"></span> times.</h11> -->
